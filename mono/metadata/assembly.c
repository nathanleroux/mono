...
GENERATE_TRY_GET_CLASS_WITH_CACHE (internals_visible, System.Runtime.CompilerServices, InternalsVisibleToAttribute)

void assembly2_clear_class_cache(void)
{
	GENERATE_CLEAR_CLASS_CACHE(internals_visible);
}
