...
GENERATE_GET_CLASS_WITH_CACHE (ienumerable, System.Collections.Generic, IEnumerable`1)
GENERATE_GET_CLASS_WITH_CACHE (icollection, System.Collections.Generic, ICollection`1)
GENERATE_GET_CLASS_WITH_CACHE (ireadonly_list, System.Collections.Generic, IReadOnlyList`1)
GENERATE_GET_CLASS_WITH_CACHE (ireadonly_collection, System.Collections.Generic, IReadOnlyCollection`1)

void verify_clear_class_cache()
{
	GENERATE_CLEAR_CLASS_CACHE(ienumerable);
	GENERATE_CLEAR_CLASS_CACHE(icollection);
	GENERATE_CLEAR_CLASS_CACHE(ireadonly_list);
	GENERATE_CLEAR_CLASS_CACHE(ireadonly_collection);
}
